# Generated by Django 3.1.2 on 2020-11-25 15:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital_address', models.CharField(max_length=2000, null=True)),
                ('reference_code', models.CharField(max_length=30, null=True)),
                ('target', models.DecimalField(decimal_places=2, max_digits=8)),
                ('donated', models.DecimalField(decimal_places=2, default=0.0, max_digits=8)),
